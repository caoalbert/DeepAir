...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 16:12:19 2024
...
MODEL_PATH_Joey = 'trained_models/jing410.pth'
PARAMS_PATH_Joey = f'trained_models/jing0410.pth'

if __name__ == '__main__':
    dataset = AirportDataset(training_start_quarter=[1, 2010],
                             batch_length=8,
                             n_train_samples=20,
                             n_test_samples=1,
    ...
    np.save('test_y_predicted_jing.npy', test_y_predicted)
    np.save('test_y_jing.npy', dataset.test_y)
